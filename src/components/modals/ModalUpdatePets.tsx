...
import { PawPrint, X, Save, Edit } from "lucide-react"
...
export function ModalUpdatePets({ trigger, system, pet }: ModalUpdatePetsProps) {
  ...
  useEffect(() => {
    if (pet) {
      ...
      setFormData({
        ...
        gender: pet.gender || "",
        active: pet.active !== undefined ? pet.active : true,
      });
    }
  }, [pet]);
