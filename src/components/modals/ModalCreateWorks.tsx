...
interface ModalCreateWorksProps {
  trigger?: React.ReactNode;
  system: string;
  insertList?: () => void;
}

export function ModalCreateWorks({ trigger, system, insertList }: ModalCreateWorksProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    api.post("admin/clinic-vet-user", employeeData).then((resp) => {
