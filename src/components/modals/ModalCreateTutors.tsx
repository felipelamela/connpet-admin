...
interface ModalCreateTutorsProps {
  trigger?: React.ReactNode;
  system: string;
}

export function ModalCreateTutors({ trigger, system }: ModalCreateTutorsProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error("Erro ao cadastrar tutor. Tente novamente.");
    } finally {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Preencha as informações abaixo para cadastrar um novo tutor
          </DialogDescription>
        </DialogHeader>
