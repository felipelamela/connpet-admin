...
export default function EditarProdutoPage() {
  ...
  const productId = searchParams.get("id");  const [isSubmitting, setIsSubmitting] = useState(false);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push("/clinica/produtos/lista");
    } catch (error) {
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Atualize as informações abaixo para editar o produto
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4">
                ...
                <Button
                  type="button"
                  variant="outline"
                  onClick={() => router.push("/clinica/produtos/lista")}
                  disabled={isSubmitting}
                  className="flex-1 sm:flex-initial"
                >
