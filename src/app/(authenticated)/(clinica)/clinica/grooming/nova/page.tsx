...
import { Scissors, Search, Save, X } from "lucide-react";
...
export default function NovoGroomingPage() {
  ...
  const [startDate, setStartDate] = useState(() => getCurrentDateTimeInSaoPaulo());
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.post("grooming", groomingData);
      if (response?.data?.success !== false) {
        toast.success("Grooming cadastrado com sucesso!");
        router.push("/clinica/grooming/lista");
      } else {
        toast.error(response?.data?.message || "Erro ao cadastrar grooming");
      }
    } catch (error: any) {
      console.error("Erro ao cadastrar grooming:", error);
      toast.error(error?.response?.data?.message || error?.message || "Erro ao cadastrar grooming");
    } finally {
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle>Novo Grooming</CardTitle>
          </div>
          <CardDescription>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={status} onValueChange={setStatus}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="DISCHARGED">Finalizado</SelectItem>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Informações adicionais sobre o grooming..."
                rows={4}
              />
            </div>
